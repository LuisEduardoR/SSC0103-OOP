 	...
 	public String play(Carta[] mao) {
		...
		// Conta o numero de pares.
 		...
 		if(straight && flush && royal) {
 			...
 			String res = "";
  			res = "Voce conseguiu formar um royal straight flush e recebeu " + (200 * aposta) + " creditos(s) de premio!";
 		...
 		if(straight && flush) {
 			...
 			String res = "";
  			res = "Voce conseguiu formar um straight flush e recebeu " + (100 * aposta) + " creditos(s) de premio!";
 		...
 		for(int i = 0; i < 13; i++) {
 			if(countCartas[i] >= 4) {
 				...
 				String res = "";
 	 			res = "Voce conseguiu formar uma quadra e recebeu " + (50 * aposta) + " creditos(s) de premio!";
 		...
 		if(hasPar && hasTrinca) {
			...
			String res = "";
 			res = "Voce conseguiu formar uma full hand e recebeu " + (20 * aposta) + " creditos(s) de premio!";
		...
		if(flush) {
			...
			String res = "";
 			res = "Voce conseguiu formar um flush e recebeu " + (10 * aposta) + " creditos(s) de premio!";
		...
		if(straight) {
			...
			String res = "";
 			res = "Voce conseguiu formar um straight e recebeu " + (5 * aposta) + " creditos(s) de premio!";
		...
		for(int i = 0; i < 13; i++) {
			if(trincas[i]) {
				...
				String res = "";
				res = "Voce conseguiu formar uma trinca e recebeu " + (2 * aposta) + " creditos(s) de premio!";
		...
		if(numPares >= 2) {
 			String res = "";
 			res = "Voce conseguiu formar dois pares e recebeu " + aposta + " creditos(s) de premio!";
 		...
 		aposta = 0;
	 	return "Voce nao consegui formar nada e perdeu sua aposta!";
 	}
